...
#include <assert.h>
#include "hyperbola.cuh"
#include "hyperbola_ps.cuh"
    ...
    int const user_info_size)
{
    ...
    case LINEAR_1D:
        ...
        break;
    case HYPERBOLA:
        calculate_hyperbola(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
    case HYPERBOLA_PS:
        calculate_hyperbola_ps(parameters, n_fits, n_points, value, derivative, point_index, fit_index, chunk_index, user_info, user_info_size);
        break;
...
void configure_model(ModelID const model_id, int & n_parameters, int & n_dimensions)
{
    ...
    case HYPERBOLA:             n_parameters = 5; n_dimensions = 1; break;
    case HYPERBOLA_PS:             n_parameters = 5; n_dimensions = 1; break;
